...
const PaymentAgents = () => (
    <div>
        ...
        <ol>
            ...
            <li>{it.L('The Agent shall not be authorized to offer its services, under this Agreement, to Clients who reside in restricted countries outlined in our terms and conditions (as amended from time to time), which are published on our website, <a href="[_1]">www.binary.me.</a>', it.url_for('new-account'))}</li>
        </ol>
        ...
        <h2 data-anchor='onboarding-policy'>I. {it.L('On-boarding Policy')}</h2>
        <ol>
        ...
        <h2 data-anchor='indemnification'>K. {it.L('Indemnification')}</h2>
        <ol>
        ...
        <h2 data-anchor='modification'>L. {it.L('Modification/Amendment')}</h2>
        ...
        <h2 data-anchor='intellectual-property-rights'>M. {it.L('Intellectual Property Rights')}</h2>
        <ol>
        ...
        <h2 data-anchor='force-majeure-event'>N. {it.L('Force Majeure Event')}</h2>
        <ol>
        ...
        <h2 data-anchor='confidentiality'>O. {it.L('Confidentiality')}</h2>
        <ol>
        ...
        <h2 data-anchor='termination'>P. {it.L('Termination')}</h2>
